...
class Council_Trainer(nn.Module):
    ...
    def gen_update(self, x_a, x_b, hyperparameters, iterations=0):
        ...
        for i in range(self.council_size):
            ...
            if hyperparameters['iteration'] > hyperparameters['focus_loss']['focus_loss_start_at_iter']:  # TODO test
                ...
                if self.do_w_loss_matching: # TODO test
                    if hyperparameters['do_a2b']:
                    ...
                    if hyperparameters['do_b2a']:
                        self.los_hist_focus_b2a_s[i].append(loss_gen_mask_total_ba_s.detach().cpu().numpy())
